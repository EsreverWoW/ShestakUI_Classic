...
L_MISC_UI_OUTDATED = "Ваша версия ShestakUI устарела. Вы можете скачать последнюю версию с https://github.com/Wetxius/ShestakUI_Classic"
...
L_SLASHCMD_HELP = {
	...
	"/moveui - Перемещение элементов интерфейса. Ctrl + ПКМ для сброса позиции",
