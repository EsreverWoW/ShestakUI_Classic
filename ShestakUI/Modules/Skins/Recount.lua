...
local function SkinButton(frame, text)
	if frame.SetNormalTexture then frame:SetNormalTexture(T.Classic and "" or C.media.empty) end
	if frame.SetHighlightTexture then frame:SetHighlightTexture(T.Classic and "" or C.media.empty) end
	if frame.SetPushedTexture then frame:SetPushedTexture(T.Classic and "" or C.media.empty) end
