...
local function LoadSkin()
	...
	for _, tab in pairs(tabs) do
		...
		tab:SetNormalTexture(T.Classic and "" or C.media.empty)
		tab:SetPushedTexture(T.Classic and "" or C.media.empty)
		tab:SetDisabledTexture(T.Classic and "" or C.media.empty)
		tab:SetHighlightTexture(T.Classic and "" or C.media.empty)
	end
