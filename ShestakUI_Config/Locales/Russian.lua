...
L.announcements_drinking = "Сообщать, когда враг начинает пить на арене"
L.announcements_interrupts = "Сообщать о вашем прерывании заклинания"
L.announcements_spells = "Сообщать, когда вы применили заклинание (из списка)"
L.announcements_spells_from_all = "Сообщать, когда применил участник группы/рейда"
L.announcements_toys = "Сообщать о применении назойливых игрушек"
L.announcements_pull_countdown = "Команда для отсчета времени до атаки (/pc #)"
L.announcements_flask_food = "Сообщать об отсутствующих настоях и еде (/ffcheck)"
...
L.announcements_feasts = "Сообщать, когда ставят пир/почту/ремонт/кодекс"
L.announcements_portals = "Сообщать, когда создают порталы/ритуал призыва"
...
L.announcements_safari_hat = "Проверять Шляпу для сафари в начале битвы петов"
