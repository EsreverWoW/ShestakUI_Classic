...
L.announcements_interrupts_desc = "Annonce /gr, /raid si vous interrompez un sort"
L.announcements_spells = "Cast spells" -- Needs review
L.announcements_spells_desc = "Annonce dans la fenêtre groupe/raid quand vous lancez certains sorts"
L.announcements_spells_from_all = "From all members" -- Needs review
L.announcements_spells_from_all_desc = "Annonce les sorts lancés par tous les membres"
...
L.announcements_flask_food_desc = "Annonce l'usage de flasques et nourriture (/ffcheck)"
...
L.announcements_safari_hat_desc = "Vérifie l'équipement du Chapeau de Safari"
