...
L.raidframe_plugins_debuffhighlight_icon = "高亮DeBuff圖標" -- Need review
...
L.chat_filter = "屏蔽無用系統信息(玩家1 在決鬥中戰勝了 玩家2)"
...
L.nameplate_clamp = "當單位名條超出屏幕時仍貼邊顯示" -- Need review
...
L.nameplate_low_health_value = "血量"
L.nameplate_low_health = "低血量邊框高亮"
...
L.announcements_interrupts = "當你斷法成功時在隊伍/團隊中進行通告"
L.announcements_spells = "當你施放指定法術時在隊伍/團隊中進行通告"
L.announcements_spells_from_all = "包括所有隊員"
L.announcements_toys = "使用玩具火車/烈酒的遙控器時進行通告"
L.announcements_pull_countdown = "倒計時通告(/pc #)"
L.announcements_flask_food = "通告食物和精煉的使用情況(/ffcheck)"
...
L.announcements_safari_hat = "檢查'狩旅團之帽'使用情況"
