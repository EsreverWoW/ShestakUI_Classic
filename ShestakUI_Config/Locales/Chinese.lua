...
L.raidframe_plugins_debuffhighlight_icon = "高亮DeBuff图标" -- Need review
...
L.chat_filter = "屏蔽无用系统信息(玩家1 在决斗中战胜了 玩家2)"
...
L.nameplate_clamp = "当单位姓名板超出屏幕时仍贴边显示" -- Need review
...
L.nameplate_low_health = "低血量边框高亮"
...
L.announcements_interrupts = "当你打断成功时在队伍/团队中进行通告"
L.announcements_spells = "当你施放指定法术时在队伍/团队中进行通告"
L.announcements_spells_from_all = "包括所有队员"
L.announcements_toys = "使用玩具火车/烈酒的遥控器时进行通告"
L.announcements_pull_countdown = "倒计时通告(/pc #)"
L.announcements_flask_food = "通告食物和合剂的使用情況(/ffcheck)"
...
L.announcements_safari_hat = "检查'狩猎帽'使用情况"
